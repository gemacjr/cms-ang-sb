package com.swiftbeard.cms.resources;

import com.swiftbeard.cms.models.News;
import com.swiftbeard.cms.models.Review;
import com.swiftbeard.cms.vo.NewsRequest;
...
public class NewsResource {
    ...
    public ResponseEntity<Review> review(@PathVariable("id") String id, @PathVariable("userId") String userId){
        return ResponseEntity.ok(new Review(id, userId));
    }
